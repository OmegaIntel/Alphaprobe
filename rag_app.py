...
uploaded_files = ["./pdf/J&J_Medtech_Report_Generation_Template.pdf"]
vectorstore = None
...
chatbot = gr.Chatbot(avatar_images=["./assets/user.jpg", "./assets/bot.png"], type="messages", height=600)
clear_but = gr.Button(value="Clear Chat")
demo = gr.ChatInterface(
    fn=chat, title="RAG Chatbot Prototype", multimodal=False, chatbot=chatbot
)
