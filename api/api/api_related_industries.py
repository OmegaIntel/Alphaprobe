...
class UserInputForThesis(BaseModel):
    __root__: Dict[str, str]

related_industries_router = APIRouter()

"""
@related_industries_router.post("/api/industries-for-thesis", response_model=None)
async def industries_for_thesis(request: List[UserInputForThesis]) -> List[str]:
