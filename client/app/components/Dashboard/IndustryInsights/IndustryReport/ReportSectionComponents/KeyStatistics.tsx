...
interface RevenueStats {
  ...
  revenue_cagr_historical?: { revenue_cagr_value?: number };
  revenue_cagr_projected?: { revenue_cagr_value?: number };
}

interface ProfitMargins {
  profit_margins_percentage?: number;
}
...
const KeyStatistics: React.FC<KeyStatisticsProps> = ({ statistics }) => {
  ...
  return (
    <div className="rounded-lg py-4 shadow-md text-lg text-gray-300">
